#include "update_basket_proxy.hpp"
...
UpdateBasketProxyHandler::UpdateBasketProxyHandler(
...
std::string UpdateBasketProxyHandler::HandleRequestThrow(
    ...
    ValidateUpdateBasketPayload(payload);
